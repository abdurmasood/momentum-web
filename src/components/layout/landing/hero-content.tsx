    ...
    <main className="absolute bottom-8 left-8 z-20 max-w-lg">
      <div className="text-left">
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <Link href={DASHBOARD_ROUTES.ROOT} className="px-8 py-3 rounded-full bg-blue-500 text-white font-normal text-xs transition-all duration-200 hover:bg-blue-600 cursor-pointer inline-block">
            Get Started
          </Link>
        </div>
      </div>
